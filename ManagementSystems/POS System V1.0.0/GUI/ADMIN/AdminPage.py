...
# importing tab Panes
from NotebookChildren.dashboard import Dashboard
...
titleLbl = Label(appBar, bg="#004C4C", text="Management by Admin [Cally]", fg="cyan", font=("Verdana", 10), anchor="w")
...
timeDateLbl = Label(appBar, text=str(datetime.now()).split(".")[0],border=3,relief="ridge", bg="#1A0224", fg="silver", font=("Verdana", 12))
...
mainContentCanvas.place(relx=0, rely=0.1 + (menuBarHeight / height), relwidth=1, relheight=1-(0.1 + (menuBarHeight / height)))
...
inventoryNtk = ttk.Notebook(mainNotebook)
productsNtk = ttk.Notebook(mainNotebook)
suppliersNtk = ttk.Notebook(mainNotebook)
printersNtk = ttk.Notebook(mainNotebook)
invoicingNtk = ttk.Notebook(mainNotebook)
...
miscNtk = ttk.Notebook(mainNotebook)

# Adding Panes to the
Dashboard(dashboardNtk)

mainNotebook.add(dashboardNtk, text="Dashboard")
mainNotebook.add(inventoryNtk, text="Inventory")
mainNotebook.add(productsNtk, text="Products")
mainNotebook.add(suppliersNtk, text="Suppliers")
mainNotebook.add(printersNtk, text="Printers")
mainNotebook.add(invoicingNtk, text="Invoicing")
mainNotebook.add(taxNtk, text="Taxation")
...
mainNotebook.add(miscNtk, text="Miscellaneous")
