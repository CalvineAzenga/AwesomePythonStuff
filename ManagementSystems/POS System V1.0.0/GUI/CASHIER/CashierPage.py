...
# import MySQLdb #: pip install mysclclient
...
window.title("")
window.wm_iconbitmap(r"C:\Users\CalvineAzenga\Downloads\Programs\sp95817.exe")
...
timeDateLbl = Label(appBar, text=str(datetime.now()).split(".")[0], border=0, relief="ridge", bg="#004C4C", fg="silver",
                    font=("Verdana", 12))
...
class tableRow():
    def __init__(self, master, index, name=None, qty=0):
