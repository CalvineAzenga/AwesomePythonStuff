from tkinter import Button, Tk, Canvas, Label, PhotoImage, Frame
...
timeDateLbl = Label(appBar, text=str(datetime.now()).split(".")[0], bg="#004C4C", fg="silver", font=("Verdana", 12))
...
tableContentsContainer1 = Frame(tableContainer, background="beige", relief="flat", highlightthickness=0, bd=3)
...
class tableRow():
    def __init__(self, master, index, name=None, qty=1):
        ...
        hey.pack(side="top", anchor="nw", fill="x", pady=1, padx=0, expand=1, ipady=5)
        ...
        col4 = Canvas(master=hey, background="#66B2B2", highlightthickness=0, borderwidth=0)
        col4.place(relx=0.7, relwidth=0.3, relheight=1)

        btnEdit = Button(col4, text="", image=editImg, compound='center', bg="#5C723D", relief="ridge", cursor="hand2",
                         fg="beige", font=("Raleway", 10))
        btnEdit.pack(side="left", ipadx=10, padx=5)

        btnDelete = Button(col4, text="", image=deleteImg, compound='center', bg="#ED862C", relief="ridge",
                           cursor="hand2", fg="#2b2b2b", font=("Raleway", 10),
                           command=delete)
        btnDelete.pack(side="left", ipadx=10, padx=5)
...
bottomPaneUpper = Canvas(bottomPane, background="#008080", highlightthickness=0, bd=0, borderwidth=0)
